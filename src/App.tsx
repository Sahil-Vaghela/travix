...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-7xl transition-all duration-500 ${isTransparent ? "bg-white/10" : "bg-white/80"} backdrop-blur-xl border border-white/20 rounded-full shadow-2xl`}>
      <div className="px-6 lg:px-10">
        <div className="flex justify-between h-16 items-center">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            ...
            <h1 className={`text-xl font-serif italic tracking-tight ${isTransparent ? "text-white" : "text-slate-900"}`}>
              Travix
            </h1>
          </Link>
                ...
                <Link
                  ...
                  className={`relative px-4 py-2 text-[10px] font-bold tracking-[0.2em] transition-all rounded-full ${
                    isActive
                      ...
                      : isTransparent ? "text-white/70 hover:text-white" : "text-slate-500 hover:text-slate-900"
                  }`}
                >
                  {item.label}
                  {!isActive && (
                          ...
                          >
                            <div className="space-y-6">
                              ...
                              <div className="flex flex-wrap gap-6 pl-14">
                                ...
                                <a
                                  href={getYoutubeUrl(place.place_name, data.city)}
                                  target="_blank"
                                  rel="noopener noreferrer"
                            ...
                            <div className="aspect-[16/10] rounded-[2rem] overflow-hidden bg-slate-100 relative shadow-2xl group-hover:neon-glow transition-all duration-500">
                              <motion.img
                                ...
                                src={place.image_url || `https://source.unsplash.com/800x600/?${encodeURIComponent(place.place_name + " " + data.city)}`}
      ...
      <div className="grid md:grid-cols-2 gap-20">
        <section>
          <div className="flex items-center gap-4 mb-12">
            ...
            <h2 className="text-4xl font-serif italic text-slate-900">Recommended Stays</h2>
          </div>
          <div className="space-y-8">
            {data.hotels.flatMap((c) => c.hotels).map((hotel, idx) => (
              <motion.div
                key={idx}
                whileHover={{ y: -10 }}
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4">
                      <p className="text-[10px] text-slate-400 uppercase tracking-widest">{hotel.area}</p>
        ...
        <section>
          <div className="flex items-center gap-4 mb-12">
            ...
            <h2 className="text-4xl font-serif italic text-slate-900">Culinary Gems</h2>
          </div>
          <div className="space-y-8">
            {data.restaurants.flatMap((c) => c.restaurants).map((rest, idx) => (
              <motion.div
                key={idx}
                whileHover={{ y: -10 }}
                className="glass p-8 rounded-[2.5rem] flex justify-between items-center group shadow-lg"
              >
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4">
                      <p className="text-[10px] text-slate-400 uppercase tracking-widest">{rest.cuisine}</p>
                      <div className="flex text-travel-sunset">
                        {[...Array(5)].map((_, i) => <Sparkles key={i} size={10} fill="currentColor" />)}
                      </div>
                    </div>
            ...
            <div className="grid sm:grid-cols-2 gap-10">
              {cat.restaurants.map((rest, rIdx) => (
                ...
                >
                  ...
                  <p className="text-slate-500 font-medium leading-relaxed relative z-10">{rest.why_visit}</p>
                </motion.div>
              ))}
            </div>
          </section>
    ...
    <div className="space-y-24">
      ...
      <div className="grid sm:grid-cols-2 gap-10">
        {transports.map((t, i) => (
          ...
          >
            <div className={`w-24 h-24 ${t.color} rounded-[2rem] flex items-center justify-center mb-8 shadow-2xl group-hover:${t.glow} transition-all duration-500 text-white`}>
              <t.icon size={36} />
            </div>
            <h3 className="text-3xl font-serif italic text-slate-900 mb-4">{t.name}</h3>
            <p className="text-slate-500 text-base mb-10 flex-grow font-medium leading-relaxed">{t.desc}</p>
            <a
              href={t.link}
              target="_blank"
              rel="noopener noreferrer"
    ...
    <div className="space-y-32 relative">
      ...
      <div className="absolute inset-0 -z-10 opacity-[0.03] pointer-events-none overflow-hidden">
        <svg viewBox="0 0 1000 500" className="w-full h-full scale-150">
          <path d="M100,100 Q200,50 300,100 T500,100 T700,100 T900,100" fill="none" stroke="currentColor" strokeWidth="2" />
          <path d="M100,200 Q200,150 300,200 T500,200 T700,200 T900,200" fill="none" stroke="currentColor" strokeWidth="2" />
          <path d="M100,300 Q200,250 300,300 T500,300 T700,300 T900,300" fill="none" stroke="currentColor" strokeWidth="2" />
        </svg>
      </div>
      ...
      <section className="text-center max-w-4xl mx-auto space-y-12">
        ...
        >
          ...
          <p className="text-xl text-slate-500 font-medium leading-relaxed">
            {data.description} Travix isn't just a travel planner. It's your personal AI concierge, 
            designed to turn every trip into a cinematic adventure.
          </p>
        </motion.div>
      </section>
      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        >
          <h3 className="text-3xl font-serif italic mb-10 text-slate-900">Key Features</h3>
          <ul className="space-y-8">
            {data.features.map((f, i) => (
              <li key={i} className="flex items-center gap-6 text-slate-600 font-medium group">
        ...
        >
          ...
          <h3 className="text-3xl font-serif italic mb-10 relative z-10">How to Use</h3>
  ...
  const [reviews, setReviews] = useState([
    {
      ...
      name: "Arjun Mehta",
      rating: 5,
      comment: "The AI itinerary for Varanasi was spot on! Saved me hours of planning.",
      date: "2 days ago",
    ...
    },
    {
      ...
      name: "Sarah Jenkins",
      rating: 4,
      comment: "Loved the restaurant recommendations in Jaipur. The palace tour was also very well organized.",
      date: "1 week ago",
    ...
    },
    {
      ...
      name: "Priya Sharma",
      rating: 5,
      comment: "Travix made my solo trip to Rishikesh so much easier. Highly recommend the spiritual trail!",
      date: "2 weeks ago",
    ...
    <div className="max-w-5xl mx-auto space-y-24 py-12">
      <section className="text-center space-y-6">
        ...
        <p className="text-slate-500 max-w-2xl mx-auto text-lg">
          Read about the experiences of fellow explorers who used Travix to plan their perfect Indian getaway.
        </p>
      </section>
      ...
      <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="flex justify-between items-start mb-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-slate-400 font-bold tracking-widest uppercase">{review.date}</p>
                  </div>
                </div>
                <div className="flex gap-1">
                  {[...Array(5)].map((_, i) => (
                    <Star 
                      key={i} 
                      size={14} 
                      className={i < review.rating ? "text-travel-sunset fill-travel-sunset" : "text-slate-200"} 
                    />
                  ))}
                </div>
              </div>
        ...
        <div className="space-y-8">
          ...
          >
            <h3 className="text-xl font-serif italic text-slate-900 mb-6">Share Your Experience</h3>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-bold uppercase tracking-widest text-slate-400 ml-2">Rating</label>
                <div className="flex gap-2 ml-2">
                  {[1, 2, 3, 4, 5].map((num) => (
                    ...
                    >
                      <Star 
                        size={20} 
                        className={num <= newReview.rating ? "text-travel-sunset fill-travel-sunset" : "text-slate-200"} 
                      />
                    </button>
                  ))}
                </div>
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-bold uppercase tracking-widest text-slate-400 ml-2">Your Review</label>
                <textarea 
                  rows={4}
...
const PageContainer = () => {
  ...
  useEffect(() => {
    if (cityParam) {
      ...
      fetchData(formattedCity, days);
    }
  }, [cityParam, days]);

  const fetchData = async (targetCity: string, _targetDays: string) => {
    setLoading(true);
    setError(null);
    ...
    const cityData = (travelData as any)[formattedCity];
  ...
  const renderContent = () => {
    ...
    if (loading)
      return (
        <div className="flex flex-col items-center justify-center py-48 space-y-6">
          <Loader2 className="animate-spin text-[#d4af37]" size={64} strokeWidth={1} />
    ...
    if (error)
      return <div className="text-center py-48 text-red-500 font-serif italic text-2xl">{error}</div>;

    if (!data) {
      const isInitialHome =
        location.pathname === "/" ||
        (location.pathname.split("/").length === 2 &&
          !["restaurants", "hotels", "transportation", "about", "reviews"].includes(
            ...
            <section className="py-48 bg-slate-50 relative">
              <div className="container mx-auto px-6">
                <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-8">
                  <div className="space-y-6">
                    <h2 className="text-6xl font-serif italic text-slate-900">
                      Cinematic <span className="text-travel-sunset">Destinations</span>
                    </h2>
      ...
      const isDataDependentPage = ["restaurants", "hotels"].some(p => location.pathname.startsWith("/" + p));
      if (isDataDependentPage) {
        const pageType = location.pathname.includes('restaurants') ? 'Restaurants' : 'Hotels';
        return (
          <div className="max-w-4xl mx-auto px-6 py-48 text-center space-y-16">
            ...
            >
              <h2 className="text-6xl font-serif italic text-slate-900">
                Find the Best <span className="text-travel-sunset">{pageType}</span>
              </h2>
              <p className="text-slate-500 text-lg font-medium max-w-2xl mx-auto">
                Enter a city name to discover curated {pageType.toLowerCase()} recommendations for your next journey.
              </p>
            </motion.div>
            ...
            >
              <form onSubmit={handleSearch} className="flex flex-col md:flex-row items-center gap-4">
                <div className="flex-1 relative w-full group">
                  <MapPin className="absolute left-6 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-travel-sky transition-colors" size={18} />
                  <input
                    type="text"
                    value={city}
                    onChange={(e) => setCity(e.target.value)}
    ...
    return (
      <div className="max-w-7xl mx-auto px-6 py-24">{switchContent()}</div>
    );
  };
  ...
  const showSearch =
    location.pathname !== "/" &&
    location.pathname !== "/transportation" &&
            ...
            >
              <div className="space-y-4">
                <label className="text-[11px] font-bold uppercase tracking-[0.3em] text-slate-400 flex items-center gap-2">
                  <MapPin size={14} className="text-travel-sunset" /> Destination City
                </label>
                <input
                  type="text"
                  value={city}
              ...
              <div className="space-y-4">
                <label className="text-[11px] font-bold uppercase tracking-[0.3em] text-slate-400 flex items-center gap-2">
                  <Calendar size={14} className="text-travel-sunset" /> Duration (Days)
                </label>
                <select
                  value={days}
                  onChange={(e) => setDays(e.target.value)}
...
const Footer = () => (
  <footer className="bg-slate-900 text-white py-32 relative overflow-hidden">
    ...
    <div className="max-w-7xl mx-auto px-6 relative z-10">
      <div className="grid md:grid-cols-4 gap-20 mb-32">
        <div className="space-y-10">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-3xl font-serif italic tracking-tight">Travix</h2>
          </div>
          <p className="text-slate-400 text-sm font-medium leading-relaxed">
            Crafted with love for the curious traveler. Discover the soul of India through our AI-powered journeys.
          </p>
          <div className="flex gap-4">
            {["INSTAGRAM", "TWITTER", "FACEBOOK"].map((social) => (
              <a key={social} href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-travel-sky transition-all duration-300 group">
        ...
        <div className="space-y-10">
          <h3 className="text-[11px] font-bold tracking-[0.4em] uppercase text-slate-500">Quick Links</h3>
          <ul className="space-y-5">
            {["Our Story", "Destinations", "Travel Guides"].map((item) => (
              <li key={item}>
                <a href="#" className="text-sm text-slate-400 hover:text-travel-sky transition-colors font-medium">{item}</a>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div className="space-y-10">
          <h3 className="text-[11px] font-bold tracking-[0.4em] uppercase text-slate-500">Support</h3>
          <ul className="space-y-5">
        ...
        <div className="space-y-10">
          <h3 className="text-[11px] font-bold tracking-[0.4em] uppercase text-slate-500">Newsletter</h3>
          <p className="text-sm text-slate-400 font-medium">Join our community of explorers.</p>
      ...
      <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="flex items-center gap-2 text-[10px] font-bold tracking-[0.2em] text-slate-600">
          MADE WITH <Heart size={12} className="text-travel-sunset fill-travel-sunset" /> BY TRAVELERS
        </div>
      </div>
    </div>
  </footer>
